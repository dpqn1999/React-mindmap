...
var RootSubLinks = /** @class */ (function (_super) {
    ...
    RootSubLinks.prototype.layout = function () {
        ...
        topic.subKeys.forEach(function (key) {
            ...
            curves.push(React.createElement("path",{className:"sublink", key: "link-" + key, d: curve, strokeWidth: linkStyle.lineWidth, stroke: linkStyle.lineColor, fill: "none" }));
        });
        this.setState({
            curves: curves
        });
...
//document.getElementsByClassName('heiecl').addEventListener("click", myFunction);
...
var TopicWidget = /** @class */ (function (_super) {
    ...
    TopicWidget.prototype.renderSubTopics = function () {
        ...
        const node = React.createElement(NodeChildren, { dir: dir, marginH: model.config.theme.marginH },
            subTopics,
            " ",
            subLinks);
    ...
    TopicWidget.prototype.layoutLinks = function () {
        ...
        var topic = model.getTopic(topicKey);
        var anchors = document.getElementsByClassName("sublink");
...
function RenderingPlugin() {
    ...
    return {
        ...
        renderSubLinks: function (props) {
            ...
            if (topic.subKeys.size === 0 || topic.collapse)
                return null;
            return React.createElement(TopicSubLinks, __assign({ ref: saveRef(linksRefKey(topicKey)) , className:"test"},   props));
                   },
...
function LinkStyleEditor(props) {
    ...
    return (React.createElement(SettingGroup, 
        React.createElement(SettingTitle, "Link"),
...
function TopicThemeEditor(props) {
    ...
    return (React.createElement(TopicThemeEditorRoot, null,
        ...
        React.createElement(SettingGroup, null,
            React.createElement(SettingTitle, null, "Background"),
            React.createElement(SettingItemColorPicker, { color: null, handleColorChange: function (color) {
                    setContentStyle({ background: color });
                } })),
        React.createElement(LinkStyleEditor, __assign({}, linkStyleEditorProps))));
}
